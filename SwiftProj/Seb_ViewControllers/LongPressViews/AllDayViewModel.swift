...
class AllDayViewModel: NSObject {
    ...
    lazy var events = [AllDayEvent(id: "0",taskid: 1,projectid: 1, title: "One", startDate: firstDate, endDate: firstDate.add(component: .day, value: 3), location: "Melbourne", isAllDay: false)]
